...
const LoginForm = ({ redirectUrl }) => {
  ...
  return (
    <>
      <form className='m-auto my-16 max-w-[500px] bg-purple-300 p-8 border-2 shadow-md rounded-md'>
        {loading ? (
          <Loader />
        ) : (
          <>
            ...
            <div className='pt-4'>
              <Link to="/signup" className='text-purple-500'>Don't have an account? Signup here</Link>
            </div>
          </>
        )}
      </form>
