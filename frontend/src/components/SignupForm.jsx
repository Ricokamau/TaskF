...
const SignupForm = () => {
  ...
  return (
    <>
      <form className='m-auto my-16 max-w-[500px] p-8 bg-purple-300 border-2 shadow-md rounded-md'>
        {loading ? (
          <Loader />
        ) : (
          <>
            ...
            <button className='bg-purple-500 text-white px-4 py-2 font-medium hover:bg-purple-600' onClick={handleSubmit}>Submit</button>

            <div className='pt-4'>
              <Link to="/login" className='text-purple-500'>Already have an account? Login here</Link>
            </div>
          </>
        )}
